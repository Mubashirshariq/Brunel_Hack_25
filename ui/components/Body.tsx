...
export const Body = () => {
    ...
    }, [mounted, publicKey, connection, refreshBalances]);
        ...
        return (
            <div className="main">
                <div className="main__block">
                    <p className="main__block-title">Loading...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="main__block">
                ...
                <div className="main__block-balance">
                    <div className="flex justify-between items-start w-full mb-4">
                        <div className="flex-1">
                            ...
                            <p className="main__block-balance-value">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="main__block-balance-value">
                                {stakedAmount.toFixed(4)} {STAKE_NAME}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="main__block-stake-block">
                    ...
                    <div className="main__block-stake-block--input-gr">
                        ...
                        /> 
                        <span className="text-yellow-400 font-semibold">{STAKE_NAME}</span>
                    </div>
                </div>

                <div className="main__block-duration-block">
                    <p className="main__block-stake-block--title">⏱️ Staking Duration</p>
                ...
                <div className="main__block-portfolio-blocks">
                    <div className="main__block-portfolio-block">
                        ...
                        <div className="block-info main__block-portfolio-block--remaining-info">
                            ...
                            <p className="main__block-portfolio-block--stake-info-data">
                                {stakeTime && !isNaN(Number(stakeTime)) 
